...
LAYOUT( \
      ...
      KC_TAB,  _00,     _01,     _02,     _03,     _04,    KC_LPRN,  KC_LBRC, _05,     _06,     _07,     _08,     _09,     KC_BSLS, \
      FN_CAPS, _10,     _11,     _12,     _13,     _14,    KC_RPRN,  KC_RBRC, _15,     _16,     _17,     _18,     _19,     KC_QUOT, \
      KC_LSFT, _20,     _21,     _22,     _23,     _24,    LH_CBR ,  RH_CBR , _25,     _26,     _27,     _28,     _29,     KC_RSHIFT, \
      KC_LCTL, KC_LGUI, KC_LALT, KC_GRV ,  ADJ,    KC_DEL , KC_BSPC, KC_INS, KC_SPC, TG(_FN),   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, \
                        KC_LBRC, KC_RBRC,          KC_SPC , KC_BSPC,  KC_ENT,  KC_SPC,           KC_LEFT, KC_RIGHT \
)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
   * |      |      | PLAY | NEXT | MUTE |      |      |  |  +   | NUM1 | NUM2 | NUM3 |      |  UP  | del  |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
  ...
  [_FN] = LAYOUT( \
      ...
      _______, _______, KC_MPLY, KC_MNXT, KC_MUTE, _______, _______, KC_PPLS, KC_KP_1, KC_KP_2, KC_KP_3, _______, KC_UP,   KC_DEL, \
      _______, TO(_ARR),_______, RGB_MOD, ADJ,     _______, _______, KC_PEQL, KC_KP_0, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, \
                        KC_VOLD, KC_VOLU,          _______, _______, _______, KC_KP_0,          KC_VOLD, KC_VOLU \
      ),
...
uint32_t layer_state_set_user(uint32_t state) {
  switch (biton32(state)) {
    case _ARR:
      layer_off(_FN);
      rgblight_sethsv_noeeprom(DEFAULT_COLOR); // #D65CE6
      rgblight_sethsv_at(FN_COLOR, 47);
      break;
    case _FN:
      rgblight_sethsv_noeeprom(FN_COLOR);// #47E6A4
      break;
    case _ADJ:
      rgblight_sethsv_noeeprom(ADJ_COLOR); // #
      break;
    default:
      rgblight_sethsv_noeeprom(DEFAULT_COLOR); // #D65CE6
      break;
